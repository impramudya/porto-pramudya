...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__tittle">Tegar Pramudya
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">I'm Programmer based in Karawang, and  I'm very passionate and dedicated to my work</p>
